...
const mao = require("../assets/mao.png");
const tesouro = require("../assets/tesouro.png");
const bolsa = require("../assets/bolsa.png");
	...
	return (
		...
		<View style={styles.nvelic}>
			...
			<TouchableOpacity
				...
				onPress={() => router.push("/Resumos/Investimentos/ResFundo")}>
				<View style={[styles.nvelicChild7, styles.nvelicChildLayout2]}>
					<Image source={bank} style={styles.imagebank} />
					<Text style={styles.erick}>Fundo Imobiliário</Text>
				</View>
			</TouchableOpacity>

			<TouchableOpacity
				style={[styles.nvelicInner2, styles.nvelicShadowBox]}
				onPress={() => router.push("/Resumos/Investimentos/ResTesouro")}>
				<View style={[styles.nvelicChild7, styles.nvelicChildLayout2]}>
					<Image source={tesouro} style={styles.imagebank} />
					<Text style={styles.erick}>Tesouro Direto</Text>
				</View>
			</TouchableOpacity>

			<TouchableOpacity
				style={[styles.nvelicInner3, styles.nvelicShadowBox]}
				onPress={() => router.push("/Resumos/Investimentos/ResConceitosTaxa")}>
				<View style={[styles.nvelicChild7, styles.nvelicChildLayout2]}>
					<Image source={maoDollar} />
					<Text style={styles.erick}>Conceitos e Taxas</Text>
				</View>
			</TouchableOpacity>

			<TouchableOpacity
				style={[styles.nvelicInner4, styles.nvelicShadowBox]}
				onPress={() => router.push("/Resumos/Investimentos/ResBolsa")}>
				<View style={[styles.nvelicChild7, styles.nvelicChildLayout2]}>
					<Image source={bolsa} style={styles.imagebank} />
					<Text style={styles.erick}>Bolsa de Valores</Text>
				</View>
			</TouchableOpacity>
